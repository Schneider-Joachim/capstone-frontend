                ...
                <ul className="col nav">
                    <li className="nav-item dropdown col-3">
                        ...
                        <ul className="dropdown-menu">
                            <li>
                                <Link className="nav-tabs dropdown-item" to="/EVBenefits">EV Benefits</Link>
                            </li>
                            <li>
                                <Link className="nav-tabs dropdown-item" to="/Terms">Terms</Link>
                            </li>
                            <li>
                            <Link className="dropdown-item" to="/Charging">Charging</Link>
                            </li>
                        </ul>
                    </li>
                    <li className="nav-item col-3">
                        <Link to="/ShopEvs" className="nav-link">Shop EV's</Link>
                    </li>
                    <li className="nav-item col-3">
