...
const Footer = () => {
    return (
<footer id="footer" className="page-footer fixed-bottom bg-dark bg-gradient bg-opacity-85">
    <div className="container-xl">
    <div className="row">
        <div className="col-3"> 
            <h5 className="text-light">Learn</h5>
                <p> 
                    <Link to="/EVBenefits" className="noUnderline">EV Benefits</Link>
                </p>

                <p>
                    <Link to="/Terms" className="noUnderline">Terms</Link>
                </p>

                <p>
                    <Link to="/Charging" className="noUnderline">Charging</Link>
                </p>
